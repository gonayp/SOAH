...
function addHerramienta() {
	...
	if(forms.alquiler_nuevo_herramientas.foundset.getSize() == 0){
		if(foundset.equipo_estado == 1){//Dsponible
			...
			forms.alquiler_nuevo_herramientas.foundset.comp_comentario_entrega = foundset.herr_equipo_to_herr_herramientas.herramienta_descripcion +" "+foundset.equipo_precio_base
